    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tất cả yêu cầu KYC (xác minh danh tính khách hàng)</h3>
                        ...
                        <tbody>
                            @foreach ($kycRequests as $kycRequest)
                                <tr>
                                    ...
                                    <!-- Lấy email của User thuộc về KycRequest này. -->
                                    ...
                                    @endif
                                    <td><a href="{{ route('admin.kyc.show', $kycRequest->id) }}">View</a></td>
                                    <!--Tạo url tới route có tên kyc.show và truyền đối tượng $kycRequest vào route đó -->
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
